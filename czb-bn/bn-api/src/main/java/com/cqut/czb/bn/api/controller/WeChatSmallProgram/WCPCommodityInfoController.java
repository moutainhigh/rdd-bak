...
public class WCPCommodityInfoController {
    ...
    @GetMapping("/getCurrentPintuanMoney")
    public JSONResult getCurrentPintuanMoney(@RequestParam String commodityId){
        return new JSONResult(wcpCommodityInfoService.getCurrentPintuanMoney(commodityId));
    }
}
