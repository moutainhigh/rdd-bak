...
public class RentCarController {
    ...
    public JSONResult addPersonContract(@RequestBody AddPersonContractInputDTO inputDTO){

        JSONResult json = new JSONResult();
        int code = rentCarService.addPersonContract(inputDTO.getPersonId(), inputDTO.getIdentifyCode());
