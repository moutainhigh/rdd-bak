...
public class VcodeConfig {
    ...
    // 替换成你的AK (产品密)
    final static String accessKeyId = "LTAIBast8tgc6pfu";// 你的accessKeyId,填你自己的 上文配置所得  自行配置
    final static String accessKeySecret = "cAwmmIGtUAmfrY9bbpAWV197NuW9fj";// 你的accessKeySecret,填你自己的 上文配置所得 自行配置
    // 必填:短信签名-可在短信控制台中找到
