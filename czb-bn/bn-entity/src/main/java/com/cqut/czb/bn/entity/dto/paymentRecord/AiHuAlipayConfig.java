...
//	public static String notify_url = SystemConstants.IPAPI+"/czb/api/verifyAsyn/verifyAsynNoticeInfoAiHu";
	//购买油卡的回调的url
	public static String notify_url ="http://106.91.17.162:8899/verifyAsyn/verifyBuyPetrolInfoAiHu";

	//充值的回调的url
	public static String recharge_url="http://106.91.17.162:8899/personCenter/VIP/purchaseVIP";

	//购买油卡充值url
	public static String PetrolRecharge_url="http://106.91.17.162:8899/verifyAsyn/verifyPetrolRechargeInfoAiHu";
