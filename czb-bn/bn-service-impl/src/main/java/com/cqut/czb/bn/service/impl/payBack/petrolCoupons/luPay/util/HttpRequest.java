...
public class HttpRequest {
     ...
     */
    public static String httpRequestGet(String url, String param) {
        String result = "";
    ...
    public static void main(String[] args) {
        //发送 GET 请求
//        String s=HttpRequest.httpRequestGet("http://39.98.250.45:8899/luPayVerifyAsyn/verifyPetrolCouponsInfo", "key=123&v=456");
